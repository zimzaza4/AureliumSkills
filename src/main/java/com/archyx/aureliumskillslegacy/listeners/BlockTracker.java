...
public class BlockTracker implements Listener {
    ...
    public boolean isCheckedBlock(BlockState state) {
        ...
        return mat.equals(Material.LOG) || mat.equals(Material.LOG_2) || mat.equals(Material.PUMPKIN) ||
                ...
                mat.equals(Material.GLOWING_REDSTONE_ORE) || mat.equals(Material.HARD_CLAY) || mat.equals(Material.STAINED_CLAY);
    }
