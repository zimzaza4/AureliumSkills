package com.archyx.aureliumskillslegacy;

import co.aikar.commands.PaperCommandManager;
import com.archyx.aureliumskillslegacy.commands.SkillsCommand;
import com.archyx.aureliumskillslegacy.commands.StatsCommand;
import com.archyx.aureliumskillslegacy.lang.Lang;
import com.archyx.aureliumskillslegacy.listeners.BlockBreak;
import com.archyx.aureliumskillslegacy.listeners.BlockPlace;
import com.archyx.aureliumskillslegacy.listeners.BlockTracker;
import com.archyx.aureliumskillslegacy.listeners.PlayerJoin;
import com.archyx.aureliumskillslegacy.loot.LootTableManager;
...
import com.archyx.aureliumskillslegacy.skills.abilities.*;
import com.archyx.aureliumskillslegacy.skills.abilities.mana_abilities.ManaAbilityManager;
import com.archyx.aureliumskillslegacy.skills.levelers.*;
import com.archyx.aureliumskillslegacy.stats.*;
import com.archyx.aureliumskillslegacy.util.HologramSupport;
import com.archyx.aureliumskillslegacy.util.PlaceholderSupport;
import com.archyx.aureliumskillslegacy.util.WorldManager;
import com.sk89q.worldguard.bukkit.WorldGuardPlugin;
import fr.minuskube.inv.InventoryManager;
import com.archyx.aureliumskillslegacy.util.WorldGuardSupport;
...
public class AureliumSkills extends JavaPlugin{
	...
	public void onEnable() {
		...
		if (getServer().getPluginManager().getPlugin("WorldGuard") != null) {
			if (WorldGuardPlugin.inst().getDescription().getVersion().contains("6.2")) {
