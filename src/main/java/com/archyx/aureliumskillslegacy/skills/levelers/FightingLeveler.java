				...
				if (e.getLastDamageCause() instanceof EntityDamageByEntityEvent) {
					...
					if (!(ee.getDamager() instanceof Arrow)) {
						...
						if (type.equals(EntityType.CHICKEN) || type.equals(EntityType.BAT) || type.equals(EntityType.OCELOT) || type.equals(EntityType.RABBIT)) {
							Leveler.addXp(p, s, Source.FIGHTING_SMALL_PASSIVE);
						}
								...
								type.equals(EntityType.SQUID) || type.equals(EntityType.HORSE) || type.equals(EntityType.SNOWMAN)) {
							Leveler.addXp(p, s, Source.FIGHTING_PASSIVE);
						}
						else if (type.equals(EntityType.WOLF) || type.equals(EntityType.SILVERFISH) || type.equals(EntityType.ENDERMITE)) {
							Leveler.addXp(p, s, Source.FIGHTING_WEAK_HOSTILE);
						}
						else if (type.equals(EntityType.ZOMBIE) || type.equals(EntityType.SKELETON) || type.equals(EntityType.SPIDER)) {
							Leveler.addXp(p, s, Source.FIGHTING_COMMON_HOSTILE);
								...
								type.equals(EntityType.SLIME) || type.equals(EntityType.MAGMA_CUBE) || type.equals(EntityType.GUARDIAN)) {
							Leveler.addXp(p, s, Source.FIGHTING_UNCOMMON_HOSTILE);
						}
							...
							Leveler.addXp(p, s, Source.FIGHTING_STRONG_HOSTILE);
						}
						else if (type.equals(EntityType.IRON_GOLEM)) {
							Leveler.addXp(p, s, Source.FIGHTING_STRONGER_HOSTILE);
						}
						else if (type.equals(EntityType.WITHER) || type.equals(EntityType.ENDER_DRAGON)) {
							Leveler.addXp(p, s, Source.FIGHTING_BOSS);
						}
						else if (type.equals(EntityType.PLAYER)) {
							Leveler.addXp(p, s, Source.FIGHTING_PLAYER);
						}
					}
				}
			}
